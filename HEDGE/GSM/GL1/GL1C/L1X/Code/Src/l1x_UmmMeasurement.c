...
Line 663: UMS: l1x_TddRscpUpdate called !
Line 680: the UTRAN RSCP update avoided for BCH(%d) PCH( %d) l1x_toggle_pending()() %d
Line 689:  ######TDD##### l1x_UmmRSCP_Adapter
Line 706: UMS: l1x_UmmInitial_Step1_Adapter called !
Line 717:  UTRAN Initial RSCP step 1 avoided for BCH(%d) PCH( %d)
Line 738: UMS: l1x_TddUmmInitial2_Adapter called !
Line 740: UMS: l1x_UmmInitial2_Adapter called when two step measurements not enabled!
Line 746: UTRAN Initial RSCP step 2 avoided for BCH(%d) PCH( %d)
Line 750:  ######TDD##### l1x_UmmInitial_Step2_Adapter
Line 773:  ######TDD##### l1x_UmmCellSearch_Adapter
Line 780:  UMM Cell Search avoided for BCH(%d) PCH( %d) l1x_toggle_pending() %d
Line 789:  ######TDD##### l1x_UmmCellSearch_Adapter
